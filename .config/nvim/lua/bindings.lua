...
vim.keymap.set("n", "<leader>gp", "<CMD>Gitsigns prev_hunk<CR>", { desc = "Git: previous hunk" })
vim.keymap.set("n", "<leader>gk", "<CMD>Gitsigns prev_hunk<CR>", { desc = "Git: previous hunk" })
